Name:Kyriakos Stylianou 
Email: kstylianou1@uclan.ac.uk
G number: 20795768

App Url: https://vesta.uclan.ac.uk/~kstylianou1/

Login Details (also you car register):
Username: Uclan
Password: uclan1234

The browser that I implemented my code to be excetuded better is google chrome.

The requirements that i manage to do are:
...
•	Demo in lab, able to answer questions on the implementation and design choices (including basic questions on usability and design principles) (**I can do that on teams**)
...
•	A professional looking prototype app (** I try my best to look like profesional and easy to the users**)
